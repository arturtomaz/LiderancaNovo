  ...
  return (
    <div>
      <div className="w-full h-40 flex items-center mt-[20px] mb-[50px]" id="home">
        ...
        <div className="mobileCtrl mx-auto w-full max-w-screen-xl px-[96px] flex justify-between items-center">
          {/* logo */}
          <img
      ...
      >
        <div className="menu-mobile--items w-[85%]">
          <a href="#home">
            <li className="hover:bg-[#364d77] p-2 duration-200 text-white">INÍCIO</li>
          </a>
          <a href="#about-us">
            <li className="hover:bg-[#364d77] p-2 duration-200 text-white">EMPRESA</li>
          </a>
          <a href="#services">
            <li className="hover:bg-[#364d77] p-2 duration-200 text-white">SERVIÇOS</li>
          </a>
          <a href="#news">
            <li className="hover:bg-[#364d77] p-2 duration-200 text-white">NOTÍCIAS</li>
          </a>
          <a href="#contact">
            <li className="hover:bg-[#364d77] p-2 duration-200 text-white">CONTATO</li>
          </a>
          <a href="" className="winker-button text-white bg-[#f28b20] p-[20px]">CONDOMÍNIO ONLINE</a>
        </div>
      </ul>
    </div>
  );
