function Services() {
  return (
    <div className="bg-[#f0f0f0] h-[770px] pb-[70px] pt-[20px]">
      <div className="mx-auto w-full max-w-screen-xl px-[96px] flex flex-col justify-center items-center">
        <h1 className="text-[#364d77] text-[64px] font-bold mb-[15px]">
          Serviços:
        </h1>
        {/* Quadrados de cima */}
        <div className="w-full flex justify-around mb-[40px]">
          {/* Área um quadrado */}
          <div className="bg-[#f0f0f0] drop-shadow-lg w-[288px] h-[218px] flex justify-center group cursor-pointer relative overflow-hidden">
            {/* Div de cima */}
            <div className="flex flex-col justify-center items-center absolute inset-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
              <img
            ...
            {/* Div de baixo */}
            <div className="bg-[#364d77] p-[10px] text-white flex flex-col justify-center items-center text-center absolute inset-0 opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
