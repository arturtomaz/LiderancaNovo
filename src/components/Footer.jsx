function Footer() {
  return (
    <div className="bg-[#364d77] w-full min-h-fit flex justify-center items-center">
      <div className="w-full container flex gap-[30px] justify-evenly pt-[30px] pb-[40px] footer overflow-hidden">
        {/* Logo e Redes Sociais */}
        <div className="logo-footer--area min-h-fit flex justify-start md:justify-center transform-out t-left mb-[40px]">
          <div className="">
            <a href="">
              <img
            ...
            <div className="flex">
              ...
              <a
                href="https://www.instagram.com/liderancacond/"
                target="_Blank"
              >
                <img
                  className="social-icons w-[50px] h-[50px] mr-[32px]"
