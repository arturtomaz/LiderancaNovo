function Banner() {
  return (
    <div className="h-[576px] flex justify-centerr">
      {/* Container */}
      <div className="mx-auto w-full max-w-screen-xl px-[96px] flex justify-between items-center">
        {/* Textos */}
        <div>
          <h1 className="text-6xl text-[#364d77] font-extrabold font-inter">
            Especialista em gestão
            <br />
            de condomínios
          </h1>
          <h2 className="text-[35px] mt-12 text-[#029ad7] font-inter font-extralight">
